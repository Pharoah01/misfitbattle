...
import { useAuth, useSubmissions, useDeleteSubmission } from '@/hooks';
...
export const Profile: React.FC = () => {
  ...
  const handleDeleteSubmission = async (submissionId: number, challengeTitle: string) => {
    if (window.confirm(`Are you sure you want to delete your submission for "${challengeTitle}"?`)) {
      try {
            ...
            <div className="relative z-10">
              <div className="flex items-start justify-between mb-8">
                <div>
                  ...
                  <p className="text-text-secondary font-rajdhani text-lg">{user?.register_number}</p>
                </div>
                <button
          ...
          <div className="bg-dark-surface rounded-lg border border-purple-primary/20 p-6 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-dark-bg rounded-lg p-4 border border-purple-primary/10">
                <label className="text-xs text-text-secondary uppercase tracking-wider block mb-2 font-rajdhani font-semibold">Register Number</label>
                <p className="text-lg text-text-primary font-mono">{user?.register_number}</p>
              </div>
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() => handleDeleteSubmission(submission.id, submission.challenge_title)}
